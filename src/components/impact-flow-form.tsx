                ...
                <div className="space-y-1 leading-none">
                  <div className="flex items-center gap-1">
                     <FormLabel className="font-normal">
                      ...
                      . I agree to allow Mastery Hub of Rwanda to process and evaluate my submission under the above guidelines. I understand that while all reasonable efforts will be made to protect my intellectual property, full protection cannot be guaranteed, and I am responsible for registering sensitive projects with RDB before submitting. *
                    </FormLabel>
                  </div>
                  <FormMessage/>
                </div>

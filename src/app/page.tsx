      ...
      <div className="w-full max-w-4xl mx-auto">
        ...
        <div className="mb-8 p-6 rounded-lg bg-card border border-border shadow-sm">
          ...
          <p className="mb-4 text-card-foreground">
            Welcome to the official application portal for the Code for Impact Competition, an initiative proudly organized by <b>Mastery Hub of Rwanda in collaboration with ALX, the One Million Rwandan Coders Initiative and Rwanda ICT Chamber.</b>
          </p>
          <p className="mb-4 text-card-foreground">
          ...
          <p className="font-headline font-bold text-lg text-center text-primary">
            ...
            <br/>
            Let big dreams begin!/ We don't just award, we incubate!
          </p>
        </div>
